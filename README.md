...
This repository is a fork of the NYTimes COVID-19 dataset repository, to which I have added a few additional datasets and a iPython notebook with basic analysis and visualizations of these datasets.

The datasets that I have added are:

- [2019 TIGER/Line Shapefiles](https://www2.census.gov/geo/tiger/TIGER2019/COUNTY/), which are provided by the US Census Bureau.
...
Below is the readme provided by the NYTimes explaining their data in greater detail.
